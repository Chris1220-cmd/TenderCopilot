...
const requirementTypeMap: Record<string, { label: string; className: string }> = {
  ...
  CERTIFICATE: { label: 'Πιστοποιητικό', className: 'bg-primary/15 text-primary border-primary/20' },
...
const platformMap: Record<string, { label: string; className: string }> = {
  ...
  ISUPPLIES: { label: 'iSupplies', className: 'bg-primary/15 text-primary border-primary/20' },
  DIAVGEIA: { label: 'Διαύγεια', className: 'bg-blue-500/15 text-blue-700 dark:text-blue-400 border-blue-500/20' },
  TED: { label: 'TED Europa', className: 'bg-primary/15 text-primary border-primary/20' },
